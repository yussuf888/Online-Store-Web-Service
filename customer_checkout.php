...
<div id="apDiv3"></div> <p>&nbsp;</p>
  ...
  <div id="apDiv2"> <p>&nbsp;</p>
<form id="form1" name="form1" method="post" action="customer_successfully.php">
  <div align="center">
    <table width="1089" border="0">
      <tr>
        ...
        <td width="300"><div align="right">
          <input name="second" type="text" class="textfield_Login" id="second" value="<?php echo $_GET['ModelName']; ?>" readonly="readonly" />
          </div></td>
        <td width="100">&nbsp;</td>
        <td width="178" class="checkout_titleorder">Company</td>
        <td width="300"><input name="seven" type="text" class="textfield_Login" id="seven" value=""/></td>
        </tr>
      <tr>
        <td height="57" class="checkout_titleorder"><div align="left">Storage</div></td>
        <td><div align="right">
          <input name="third" type="text" class="textfield_Login" id="third" value="<?php echo $_GET['Storage']; ?>" readonly="readonly" />
          </div></td>
        <td width="100">&nbsp;</td>
        <td width="178" class="checkout_titleorder">Address</td>
        <td><input name="eight" type="text" class="textfield_Login" id="eight" value=""/></td>
        </tr>
      <tr>
        <td height="58" class="checkout_titleorder"><div align="left">Color</div></td>
        <td><div align="right">
          <input name="fourth" type="text" class="textfield_Login" id="fourth" value="<?php echo $_GET['Color']; ?>" readonly="readonly" />
          </div></td>
        <td width="100">&nbsp;</td>
        <td width="178" class="checkout_titleorder">Contact</td>
        <td><input name="nine" type="text" class="textfield_Login" id="nine" value=""/></td>
        </tr>
      <tr>
        <td height="57" class="checkout_titleorder"><div align="left">Unit Price</div></td>
        <td><div align="right">
          <input name="fifth" type="text" class="textfield_Login" id="fifth" value="<?php echo $_GET['Price']; ?>" readonly="readonly" />
          </div></td>
        <td width="100">&nbsp;</td>
        <td width="178" class="checkout_titleorder">Email</td>
        <td><input name="tenth" type="text" class="textfield_Login" id="tenth" value=""/></td>
        </tr>
      <tr>
        <td class="checkout_titleorder"><div align="left">Quantity</div></td>
        <td><div align="right">
          <input name="sixth" type="text" class="textfield_Login" id="sixth" value=""/>
          </div></td>
        <td width="100">&nbsp;</td>
      ...
      <tr>
        <td class="checkout_titleorder"><div align="left"></div></td>
        <td><div align="right"></div></td>
        <td width="100"><input name="submit" type="submit" class="button_cart" id="submit" value="Checkout" /></td>
        <td width="178" class="checkout_titleorder">&nbsp;</td>
        </tr>
    </table>
</div></form></div>
